...
Single source of truth: `common.TOPIC_TO_CAM_CHANNEL`. Never re-declare it in a
script — import it. See README for the table.

## Intermediate format
See README "Intermediate format".

## Default paths
- Intermediate root: `/data/intermediate/` (CLI overridable)
- Calibration source: `calib/2025_6_27/` (CLI overridable)
